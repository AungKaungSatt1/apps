		...
		<>
			<div className='mx-[75px] flex flex-col flex-wrap'>
				<div className='mt-[150px] flex w-full mb-10'>
					<div className='py-[50px] ps-[50px] w-[400px] border-r-1 border-r-(--border-color)'>
						<img
					...
					<span className='p-[30px] inline-block'>
						...
						<div className='flex justify-between mb-[15px] w-185'>
							<strong className='text-[1.4em]'>{meal.name}</strong>
						...
						<div className='flex flex-row mb-[25px]'>
							<strong className='border-e pe-[15px] me-[15px]'>3 Photos</strong>
							<strong className='underline cursor-pointer border-e pe-[15px] me-[15px]'>
								{meal.reviews.length || 0} Reviews
							</strong>
							<span className='text-[#9A9A9A]'>Created on 20:30pm 24/3/25</span>
						</div>
						<div className='w-175'>
							<p className='text-[16px] text-base/[30px] mb-[25px]'>
								{meal.description}
							</p>
				...
				<strong className='text-[25px] ms-[15px] mt-[20px]'>Similar Dishes</strong>
				<Carousel />
				<strong className='text-[25px] ms-[15px]'>Reviews</strong>
				<div>
					{reviews.length == 0 ? (
						<div>No reviews</div>
					) : (
